"""Modulo para UnitTest de modulo customer"""
...
class TestCustomer(unittest.TestCase):
    """Clase para realizar pruebas de Customer"""
    def setUp(self):
        """Metodo de SetUp"""
        self.customer = Customer(customer_id = 'setup',
                                 first_name = 'First',
                                 last_name = 'Last',
                                 phone = 1234567890)
    ...
    def test_create_customer(self):
        """Metodo de verificacion de creacion de cliente"""
        Customer.create_customer('create_test', 'Create', 'Test', 2)
        expected_filename = "customer_create_test.json"
        self.assertTrue(os.path.exists(expected_filename), "Customer file should exist")

        os.remove("customer_create_test.json")

    def test_load_file(self):
        """Metodo de verificacion de carga de cliente"""
        load_test_customer = Customer.create_customer('load_test', 'Load', 'Test', 3)
        ...
        self.assertEqual(loaded_customer.phone,
                         load_test_customer.phone,
                         "Phone Numbers should be the same")

        os.remove("customer_load_test.json")

    def test_delete_customer(self):
        """Metodo de verificacion de eliminacion de cliente"""
        ...
        self.assertFalse(os.path.exists(expected_filename), "Customer file should not longer exist")

    def test_display_customer(self):
        """Metodo de verificacion de visualizacion"""
        customer = Customer('display_test', 'Display', 'Test', 5)
        disp = "Customer ID: display_test, First Name: Display, Last Name: Test, Phone Number: 5\n"
